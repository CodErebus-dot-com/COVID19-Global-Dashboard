...
import DailySpreadTrends from "../SpreadTrends/DailySpreadTrends";
import CummulativeSpreadTrends from '../SpreadTrends/CummulativeSpreadTrends'
          ...
          <div class="grid-container">
            ...
            <div className="app__stats">
              ...
              <div className="app__graph">
                <h1 style={{fontSize: "40px", color: "#6c757d", display: "flex", justifyContent: "center"}}>Spread Trends</h1>
            ...
            <div class="grid2">
              ...
              <div className="app__overview">
                <h1 style={{fontSize: "40px", color: "#6c757d", display: "flex", justifyContent: "center"}}>Overview</h1>
                <Overview 
                  country={country}
